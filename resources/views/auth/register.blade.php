                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                               ...
                               <div class="form-group{{ $errors->has('city') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" placeholder="{{ __('city') }}" type="city" name="city" value="{{ old('city') }}" required>
                                </div>
                                @if ($errors->has('city'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
                            ...
                            <div class="form-group{{ $errors->has('pincode') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control{{ $errors->has('pincode') ? ' is-invalid' : '' }}" placeholder="{{ __('pincode') }}" type="pincode" name="pincode" value="{{ old('pincode') }}" required>
                                </div>
